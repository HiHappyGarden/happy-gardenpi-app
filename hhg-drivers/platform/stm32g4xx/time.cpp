...
os::exit time::set_rtc(time_t timestamp, os::error **error) OS_NOEXCEPT
{
...
::tm time::get_rtc(os::error **error) const OS_NOEXCEPT
{
	RTC_TimeTypeDef local_time = {0};
	RTC_DateTypeDef local_date = {0};
...
bool time::wait_for_synchro(uint64_t timeout) const OS_NOEXCEPT
{
	/* Clear RSF flag */
